...
@Component({
  selector: 'app-photo-grapher-client',
standalone: false,
  templateUrl: './photo-grapher-client.component.html',
  styleUrl: './photo-grapher-client.component.css',
     providers: [provideMomentDateAdapter(MY_FORMATS)],
     changeDetection: ChangeDetectionStrategy.OnPush,
})
export class PhotoGrapherClientComponent implements OnInit {
  selectedDate: any = '';
  ...
  displayedColumns: string[] = [
    ...
    'clientCategory',
    'noOfYouTubeVideos',
     'totYouTubeVideosShotCount',
    'percentOfYouTubeVideosShot',
    'noOfEducationalReels',
    'totEducationalReelsShotCount',
    'percentOfEducationalReelsShot',
    'actions',
  ];
  ...
  fetchClients(): void {
    ...
    this.operationsService.getclientsByVideoGrapher(this.userId, this.selectedDate).subscribe({
      next: (response: any[]) => {
        ...
        this.dataSource1.data = response.map((client, index) => ({
          ...
          percentOfYouTubeVideosShot: client.percentOfYouTubeVideosShot,
          totEducationalReelsShotCount: client.totEducationalReelsShotCount,
          totYouTubeVideosShotCount: client.totYouTubeVideosShotCount,
          percentOfEducationalReelsShot: client.percentOfEducationalReelsShot,
