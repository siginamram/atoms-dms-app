    ...
    this.operationsService.getclientByClientId(clientId).subscribe({
      next: (data: any) => {
        ...
        this.editForm.patchValue({
          ...
          contentWriter: data.clientResourceAllocation?.opContentWriterID || null,
          photographer: data.clientResourceAllocation?.opPhotographerID || null,
          posterDesigner: data.clientResourceAllocation?.opGraphicDesignerID || null,
          videoEditor1: data.clientResourceAllocation?.opVideoEditor1ID || null,
          videoEditor2: data.clientResourceAllocation?.opVideoEditor2ID || null,
          dma: data.clientResourceAllocation?.opDMAID || null,
