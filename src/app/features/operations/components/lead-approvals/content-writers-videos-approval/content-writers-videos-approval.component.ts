...
@Component({
  selector: 'app-content-writers-videos-approval',
  standalone:false,
  templateUrl: './content-writers-videos-approval.component.html',
  styleUrl: './content-writers-videos-approval.component.css',
   providers: [provideMomentDateAdapter(MY_FORMATS)],
})
export class ContentWritersVideosApprovalComponent implements OnInit {
  ...
  fetchGraphicApprovalRequests(): void {
    ...
    this.operationsService.videoContentApprovalRequests(userId, `${selectedDate}-01`).subscribe({
      next: (response) => {
