...
@Component({
  selector: 'app-video-editor-approval-history',
  standalone:false,
  templateUrl: './video-editor-approval-history.component.html',
  styleUrl: './video-editor-approval-history.component.css',
