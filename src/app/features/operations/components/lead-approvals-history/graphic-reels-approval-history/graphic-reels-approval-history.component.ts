...
@Component({
  selector: 'app-graphic-reels-approval-history',
  standalone:false,
  templateUrl: './graphic-reels-approval-history.component.html',
  styleUrl: './graphic-reels-approval-history.component.css',
  providers: [provideMomentDateAdapter(MY_FORMATS)],
})
export class GraphicReelsApprovalHistoryComponent implements OnInit {
