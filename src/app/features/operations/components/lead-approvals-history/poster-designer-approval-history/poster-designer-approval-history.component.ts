...
@Component({
  selector: 'app-poster-designer-approval-history',
  standalone:false,
  templateUrl: './poster-designer-approval-history.component.html',
  styleUrl: './poster-designer-approval-history.component.css',
  providers: [provideMomentDateAdapter(MY_FORMATS)],
})
export class PosterDesignerApprovalHistoryComponent implements OnInit {
  ...
  fetchGraphicApprovalRequests(): void {
    ...
    this.operationsService.graphicApprovalHistory(userId, `${selectedDate}-01`, creativeType).subscribe({
      next: (response) => {
